/*
 * Stoatworks Labs - About window data for Proximate.
 *
...
{
    inline constexpr auto name = "Proximate";
    inline constexpr auto slug = "proximate";
    inline constexpr auto hook = "One knob against the proximity effect";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/proximate/guide/";
    inline constexpr auto page = "https://stoatworks-labs.com/software/proximate/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/proximate";
