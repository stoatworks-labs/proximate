# Running Proximate — Gatekeeper, SmartScreen and firewalls
...
```sh
spctl -a -vv -t install "/Applications/Proximate.app"
spctl -a -vv -t install "/Library/Audio/Plug-Ins/VST3/Proximate.vst3"
...
Unsigned binaries occasionally get quarantined outright by
